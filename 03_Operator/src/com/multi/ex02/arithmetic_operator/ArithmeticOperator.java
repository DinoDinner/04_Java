...
public class ArithmeticOperator {
	public static void main(String[] args) {
		...
		System.out.println(a / 3.0); 	   // 소수점 표현법1 - double로 3.0을 사용
		System.out.println(a / (double)3); // 소수점 표현법2 - 3을 명시적으로 3.0으로 바꾼 문법
		System.out.println((double)(a / 3)); // 안되는 표현법!! 3 -> 3.0된다.
...
//		System.out.println(a / 0); // java.lang.ArithmeticException 
		...
		c = 5;
		if(c % 2 == 0) { // 짝수 일 때
			System.out.println(c + "는 짝수입니다."); // 참일때 실행되는 문장
		} else { // 홀수 일 때
			System.out.println(c + "는 홀수입니다."); // 거짓일때 실행되는 문장
		}
		
		// ※ 정수 + 실수 사용시 주의점
		//  - 사칙연산시 type의 크기가 큰쪽으로 자동으로 형변환 된다.
