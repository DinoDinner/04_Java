...
public class CompareOperator {
	public static void main(String[] args) {
		...
		System.out.println(a != b); // a와 b가 같지 않은지?
		System.out.println("-----------------------------");
		
		// 문자열 비교... ※주의 : 이해하기 매우 어려움!!!
		String str1 = "안녕하세요?"; // spring pool
		String str2 = "안녕하세요?"; // "안녕하세요?"-> spring pool, new String -> heap
		String str3 = new String("안녕하세요?");
		
		System.out.println(str1 == str2); // 예측 : true
		System.out.println(str1 == str3); // 예측 : true -> 틀림! false임
		
		// String 비교시에는 항상 주의 필요, '=='을 사용하면 틀린 결과가 나올수 있다!!
		// 문자열 비교는 equals 메소드를 사용할것! ★★★★★
