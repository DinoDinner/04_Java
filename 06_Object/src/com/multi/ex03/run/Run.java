...
public class Run {
	public static void main(String[] args) {
		// Person 실습 시작
		Person p = new Person(); // 객체 변수로 선언시에는 줄임말 또는 한글자로 사용해도 허용하는 추세!

		System.out.println("Person default 값 출력!");
		System.out.println(p.name); // 생성자에서 초기화 된 값이 출려
		System.out.println(p.age);  // 숫자 값는 0에 준하는 값으로 초기화
		System.out.println(p.phoneNum); // 참조형는 일반적으로 null로 초기화
		...
		// PersonVO 실습 시작
		PersonVO p2 = new PersonVO("홍길동", 31, "010-1234-5678", "서울시 강남구");
