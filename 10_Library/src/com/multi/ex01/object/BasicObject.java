...
public class BasicObject {
	...
	public static void main(String[] args) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		...
		System.out.println(object1); // java.lang.Object@3d012ddd : Class이름@해쉬코드=식별자
		System.out.println(object1.toString());
		System.out.println(object2.toString()); // String에 오버라이드 된 toString()
		System.out.println(object3.toString()); // String에 오버라이드 된 toString()
		...
		// equals : 객체간의 고유 번호 비교, 성능적으로 이득을 보기 위해
