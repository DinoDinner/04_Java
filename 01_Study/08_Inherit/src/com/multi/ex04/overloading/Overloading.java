...
//	}
	...
	public static void main(String[] args) {
		...
		// 만일 오버로딩이 문법적으로 적용되지 않으면?
		// 메소드 이름을 분리해야함. --> C, C++에서는 아래 방법으로 오버로딩을 대체함
//		System.out.printlnI(12); // int
//		System.out.printlnF(3.14); // double 
...
//		System.out.printlnS("안녕?"); // String  
	...
	public void print(String name, String age) {
		print(name,age,""); // 인자가 가장 많은 메소드를 재사용한다!
	}
	
	public void print(String name) {
		print(name,"",""); // 인자가 가장 많은 메소드를 재사용한다!
	}
}
