...
public class DateTest {
	...
	public static void main(String[] args) {
		// Date - java 1.0부터 날짜 Type로 활용
		Date date = new Date();
		System.out.println(date); // 오늘 날짜 출력
		System.out.println(date.getTime()); // 1970년부터 현재 까지 흐른 ms단위 
		System.out.println(System.currentTimeMillis()); // 위 같은 시간 출력 
//		1679644156296 = 1970년부터 오늘 현재까지의 흐른 ms 시간
		...
		// Calendar : Date를 개선한 Library -> Date 더 안쓰인다;
		// 특징 : 자체 생성이 불가능!! 
